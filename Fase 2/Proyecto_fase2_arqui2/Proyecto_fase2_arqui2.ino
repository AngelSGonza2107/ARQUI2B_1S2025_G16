...
void verificarServo()
{
    //Si el servo está abierto y han pasado 5 segundos, cerrarlo si la lectura del sensor de ultrasonido de la entrada es menor a 10cm
...
void enviarDatosSerial()
{
    ...
    Serial.println(String(temperatura) + "," + String(humedad) + "," + String(distancia) + "," + String(luz) + "," + String(calidadAire) + "," + String(corriente) + "," + String(distancia) + "," + String(puerta));
}
